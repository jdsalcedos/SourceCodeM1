...
public class VentanaRegistro extends JFrame {
	...
	public boolean verify() {
		...
		if (txtIdentificacion.getText().trim().isEmpty()) {
			JOptionPane.showMessageDialog(this, "Hace falta llenar el campo de identificacion", "Advertencia",
					JOptionPane.WARNING_MESSAGE);
			return false;
		}

		if (txtNombre.getText().trim().isEmpty()) {
			JOptionPane.showMessageDialog(this, "Hace falta llenar el campo de nombre", "Advertencia",
					JOptionPane.WARNING_MESSAGE);
			return false;
		}

		if (txtTelefono.getText().trim().isEmpty()) {
			JOptionPane.showMessageDialog(this, "Hace falta llenar el campo de teléfono", "Advertencia",
					JOptionPane.WARNING_MESSAGE);
			return false;
		}

		if (txtCorreo.getText().trim().isEmpty()) {
			JOptionPane.showMessageDialog(this, "Hace falta llenar el campo de correo", "Advertencia",
					JOptionPane.WARNING_MESSAGE);
			return false;
		}

		if (txtDireccion.getText().trim().isEmpty()) {
			JOptionPane.showMessageDialog(this, "Hace falta llenar el campo de dirección", "Advertencia",
					JOptionPane.WARNING_MESSAGE);
			return false;
		}
		...
		if (!rdBtnAutor.isSelected() && !rdBtnLector.isSelected()) {
			JOptionPane.showMessageDialog(this, "Hace falta elegir autor o lector", "Advertencia",
					JOptionPane.WARNING_MESSAGE);
			return false;
		}
		return true;
	...
	public void avisoError() {
		JOptionPane.showMessageDialog(this, "Ya existe alguien con ese ID, digite otro.", "Error",
